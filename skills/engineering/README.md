...
- **[pd-separation](./pd-separation/SKILL.md)** — Deploy or diagnose vLLM-DLC Prefill/Decode separation with MooncakeDLCConnector; use for single-node TCP or lyp_full, cross-machine TCP, Prefill/Decode/Proxy startup, KV-transfer lifecycle, routing, and PD-specific health or transfer failures.

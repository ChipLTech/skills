...
- Read-only vllm-cl revision and worktree-state snapshot.
...
- [ ] No file in the vllm-cl repository is modified or generated.

## Stop Conditions

- The public runner seam cannot be implemented in the skills repository without changing vllm-cl.
...
- The vllm-cl worktree changes during the ticket for any reason attributable to this work.

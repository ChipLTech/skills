...
- Campaign: `/tmp/kilo/vllm-cl-ticket06-campaign-v12-20260718/campaign.json`.
- Aggregate: `/tmp/kilo/vllm-cl-ticket06-runs-v12-20260718/ticket06-operational-index.json`.
- Model Adaptation consumer: `/tmp/kilo/vllm-cl-ticket06-runs-v12-20260718/model-adaptation-operational.json`.
- Main-to-Main consumer: `/tmp/kilo/vllm-cl-ticket06-runs-v12-20260718/main-to-main-operational.json`.
...
- Read-only vLLM and vllm-cl full revisions and worktree-state snapshots.
- Ticket 02's versioned runner, timeout policy, runtime event contract, and artifact destination outside vllm-cl.
...
- [ ] All artifacts are written outside vllm-cl and vllm-cl remains unchanged.
...
- Continuing would require downloading an unapproved substitute or modifying vllm-cl.
- The tested source revision cannot be uniquely identified.
- Artifact isolation outside vllm-cl cannot be guaranteed.
...
- Before/after vllm-cl full revision and worktree-state comparison showing zero ticket-created changes.

...
`/tmp/kilo/vllm-cl-ticket07-recovery-20260718T122139Z/evidence`
...
- `/work/vllm` and `/work/vllm-cl` before/after closed inventories are equal.
...
- [ ] No vllm-cl file, metadata, branch, or worktree state is changed.
...
- Correct publication would require editing vllm-cl.

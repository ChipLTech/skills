...
def main() -> int:
    ...
    parser.add_argument("--expected-vllm-cl-root", required=True, type=Path)
    ...
    for module, root in {
        ...
        "vllm_cl": arguments.expected_vllm_cl_root.resolve(),
        "vllm_cl.vllm_cl_C": arguments.expected_vllm_cl_root.resolve(),
    }.items():

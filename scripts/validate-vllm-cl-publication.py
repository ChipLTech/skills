#!/usr/bin/env python3
"""Validate stable vLLM-CL skill publication surfaces."""
...
def validate_skill(args: argparse.Namespace, identity: str) -> dict[str, Any]:
    ...
    if identity == "model-adaptation":
        qualification_assets = (
            ...
            "scripts/validate-vllm-cl-qualification.py",
            "scripts/run-dlccl-qualification.py",
            "scripts/inventory-vllm-cl-collectives.py",
            "scripts/attest-vllm-cl-qualification.py",
            "scripts/collect-vllm-cl-live-identity.py",
            ...
            "scripts/_generated_contracts/vllm-cl-collective-selection-v1.schema.json",
        )
...
def main() -> int:
    ...
    before = {"vllm": repository_snapshot(args.vllm_root), "vllm_cl": repository_snapshot(args.vllm_cl_root)}
    try:
        ...
        after = {"vllm": repository_snapshot(args.vllm_root), "vllm_cl": repository_snapshot(args.vllm_cl_root)}
        emit({
            "contract_version": CONTRACT_VERSION,

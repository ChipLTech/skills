...
VALIDATOR = ROOT / "skills" / "engineering" / "model-adaptation" / "scripts" / "validate-vllm-cl-qualification.py"
...
class DistributedCollectiveQualificationTests(unittest.TestCase):
    ...
    def test_v1_is_frozen_and_v2_requires_exact_selection_shape(self):
        ...
        self.assertEqual(result.returncode, 0, result.stdout)
        self.assertEqual(json.loads(result.stdout)["schema_version"], "vllm-cl-distributed-collective-qualification/v2")

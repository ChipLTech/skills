...
SCRIPT = ROOT / "skills/engineering/model-adaptation/scripts/collect-vllm-dlc-live-identity.py"
ATTESTER_SCRIPT = ROOT / "skills/engineering/model-adaptation/scripts/attest-vllm-dlc-qualification.py"
...
class LiveIdentityCollectorTests(unittest.TestCase):
    ...
    def spec(self):
        return {
            "schema_version": "vllm-dlc-live-identity-collector-spec/v1",
